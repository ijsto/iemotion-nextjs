...
You can see a live demo of this repo at [iemotion-nextjs.now.sh](https://iemotion-nextjs.now.sh/)
...
1. Clone the the [starter repo](https://github.com/ijsto/iemotion-nextjs)

```

git clone git@github.com:ijsto/iemotion-nextjs.git
